...
import radhey.util.SortedFastGrowingList;
import radhey.util.SortedFastGrowingList2;
...
public class AutoCompleteComboBox extends JComboBox{
    ...
    public boolean isSorted(){
        List data=((ListComboBoxModel)dataModel).getData();
        return data instanceof SortedFastGrowingList || data instanceof SortedFastGrowingList2;
    }

    public boolean isIgnoreCase(){
        List data=((ListComboBoxModel)dataModel).getData();
        if(data instanceof SortedFastGrowingList)
            return ((SortedFastGrowingList)data).isIgnoreCase();
        return false;
    }
    ...
    public AutoCompleteComboBox(boolean sorted,boolean ignoreCase){
        super(new ListComboBoxModel(new SortedFastGrowingList(ignoreCase)));
        addPopupMenuListener(new APopupMenuListener());
        if(!sorted)
    ...
    public AutoCompleteComboBox(List<?> items) {
        super(new ListComboBoxModel(items));
        addPopupMenuListener(new APopupMenuListener());
        this.setEditable(true);
        JTextComponent editComponent;
        editComponent=(JTextComponent)getEditor().getEditorComponent();
    ...
    public AutoCompleteComboBox(ListComboBoxModel aModel) {
        super(aModel);
        addPopupMenuListener(new APopupMenuListener());
        this.setEditable(true);
        JTextComponent editComponent;
    ...
    public void setModel(ComboBoxModel model){
        if(!(model instanceof ListComboBoxModel))
                throw new UnsupportedOperationException("Model not supported by AutoCompleteCombobox. Use ListComboBoxModel");
        super.setModel(model);
    }

    public void setModel(ListComboBoxModel model){
        super.setModel(model);
    }
    ...
    public int getSelectedIndex() {
            return ((ListComboBoxModel)dataModel).getSelectedIndex();
    }
    ...
    public void setSelectedIndex(int anIndex) {
        ...
        if ( anIndex == -1 ) {
            ...
            ListComboBoxModel ldataModel=(ListComboBoxModel)dataModel;
    ...
    public void setSelectedItem(Object anObject) {
        ...
        if ((oldSelection!=anObject) &&  (oldSelection == null || !oldSelection.equals(anObject))) {
            if (anObject != null && !isEditable()) {
                ...
                // will be rejected.
                index=((ListComboBoxModel)dataModel).indexOf(anObject);
            ...
            // call may result in ListDataEvents being fired.
            isSelectingItem = true;
            ((ListComboBoxModel)dataModel).setSelectedIndex(index);
            isSelectingItem = false;
    ...
    class AutoCompleteDocument extends javax.swing.text.PlainDocument{
        ...
        public int match(String s){
            return ((ListComboBoxModel)dataModel).indexOfStartsWith(s);
        }
    ...
    class AFocusListener implements FocusListener{
        ...
        public void focusGained(FocusEvent e) {
            ...
            if(listeners.length>1){
                e=new FocusEvent(AutoCompleteComboBox.this, e.getID(), e.isTemporary(), e.getOppositeComponent());
    ...
    class AKeyListener extends KeyAdapter{
        ...
        public void keyPressed(KeyEvent e) {
           ...
           if(listeners.length>1){
               e=new KeyEvent(AutoCompleteComboBox.this, e.getID(),e.getWhen(),e.getModifiers(),e.getKeyCode(),e.getKeyChar(),e.getKeyLocation());
               for(int ctr=1;ctr<listeners.length;ctr++)
    ...
    class AMouseListener extends MouseAdapter{
        ...
        public void mouseClicked(MouseEvent e) {
            MouseEvent e2=new MouseEvent(AutoCompleteComboBox.this, e.getID(), System.currentTimeMillis(), e.getModifiers(), e.getX(), e.getY(), e.getXOnScreen(), e.getYOnScreen(), e.getClickCount(), e.isPopupTrigger(), e.getButton());
            AutoCompleteComboBox.this.dispatchEvent(e2);
        }
